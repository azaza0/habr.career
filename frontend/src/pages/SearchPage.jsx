...
import { Center, FormControl, Input, Flex, Button, Spinner, Box, Select } from '@chakra-ui/react';
        ...
        <Center mt={"30px"}>
            <Flex flexDir={"column"} gap={'20px'}>
                <Box display={"flex"} gap={"20px"}>
                    ...
                    <FormControl>
                        <Input placeholder='Поиск по скилам' value={skill} onChange={handleInputChange} />
                    </FormControl>
